...
Each axis is composed by one or two quantities, each one of them defined as an entry ('1', '2') in the dictionary that specifies the axis. Each quantity is described by a list of items that selects the type of quantity to be used.
